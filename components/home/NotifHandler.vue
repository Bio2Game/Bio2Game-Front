<template>
  <div v-if="display" class="notif-container">
    <div class="notif" :class="{ hide, small }" @click="small = !small">
      <svg class="notif-icon" width="32" height="40" viewBox="0 0 32 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
      ...
      <div class="wrapper">
        <div class="quiz">
          ...
          <div class="quiz-content">
            ...
            <div class="description">Qu'est ce que le devoir de vigilance des entreprises</div>
          </div>
        </div>
        <div class="buttons">
